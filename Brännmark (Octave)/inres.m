...
function inres()
	...
	% Time series
	t = linspace(0,100,100); % Use up to 1000 for equilibrium
	x = lsode('f',x0,t);
  ...
  plot(t,x(:,20),';AS160;', t,x(:,28),'--;AS160 approx;', t,x(:,21),';AS160p;', t,x(:,29),'--;AS160p approx;', t,x(:,24),';S6K;', t,x(:,30),'--;S6K approx;', t,x(:,25),';S6Kp;', t,x(:,31),'--;S6Kp approx;');
  legend('location', 'eastoutside');
  legend boxoff
  xlabel('time (min)');
  ylabel('mol/L');
  set(gca, 'FontSize', 5, 'xtick', 0:10:100, 'ytick', 0:10:100);
  pbaspect([1 0.75 1]);
end
...
function xdot = f(x,t)
	...
	n9   = 0.9855;              % n9
	% For approximation of Hill-type kinetics with power law
	k29p = 1.12650518621011;    % k9'
	k33p = 2.62554992841910e-5; % k33'
	p29  = 0.825618172988512;   % p29
	q33  = 0.971623996429415;   % q33
